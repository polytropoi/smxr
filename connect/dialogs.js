  ...
  // //     //     ];
    ...
    navigator.mediaDevices
      ...
      .finally(() => {
        ...
        if (audioSelector) {
          audioSelector.innerHTML = "<option value=\x22none\x22>none</option>" + audioInputDevices;
        }
        if (cameraSelector) {
          cameraSelector.innerHTML = "<option value=\x22none\x22>none</option>" + cameraInputDevices;
        }
