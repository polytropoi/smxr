...
const wgpu_router = express.Router();
...
wgpu_router.get("/test", function (req, res) {
    res.send("OK!");
});    
...
wgpu_router.get('/simple_three', function (req, res) { 
...
wgpu_router.get('/:_id', function (req, res) { 
